...
public class WhiteGraveyardController {
    ...
    private void initialize() {
        ...
        queenImage.setImage(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/wQG.png"))));
        rookImage.setImage(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/wRG.png"))));
        bishopImage.setImage(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/wBG.png"))));
        knightImage.setImage(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/wNG.png"))));
        pawnImage.setImage(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/wPG.png"))));
